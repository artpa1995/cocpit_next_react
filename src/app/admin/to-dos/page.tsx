...
export default function Home() {
  ...
  const fetchPageData = async () => {
    try {
      const response = await axios.post(`/api/page_info/get_page_info/info`, { page_id: 3 });
        ...
        <div className="admin_dashboard">
          ...
          <div className="form">
            ...
            <div className="form_items">
              <div className="form_labels">Icon</div>
              <input
                type="text"
            ...
            <div className="form_items">
              <div className="form_labels">Prompt Text</div>
              <input
                type="text"
            ...
            <div className="flex gap-6">
              <div className="form_items">
                <div className="form_labels">Trigger Conversation</div>
                <input
                  type="text"
                  ...
                  placeholder="Trigger Conversation"
                  className='rounded-lg px-5 py-3 border border-grey-600'
                />
              </div>
            </div>
