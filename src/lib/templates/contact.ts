export const contact = `<!DOCTYPE html>
...
<body class="body" style="background-color: #B8CCE2; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #B8CCE2;">
		<tbody>
			<tr>
				<td>
														...
														<tr>
															<td class="pad">
																<div style="color:#132F40;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:22px;line-height:120%;text-align:left;mso-line-height-alt:26.4px;">
																	<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">User <strong>{{name}}</strong> want contanct with you</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
														<tr>
															<td class="pad" style="padding-bottom:30px;padding-left:10px;padding-right:10px;padding-top:5px;">
																...
																<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">Message!&nbsp;</span><br><span style="word-break: break-word;"></p>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:20px;">
																<div style="color:#555555;font-family:'Cabin', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	<p style="margin: 0; word-break: break-word;"><br><span style="word-break: break-word;">User email is: <span style="word-break: break-word; color: rgb(255,191,0);"><strong>{{email}}</strong></span></span></p>
																</div>
															</td>
														</tr>
													</table>
